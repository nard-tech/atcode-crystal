...
# TLE
# https://atcoder.jp/contests/past202004-open/submissions/12819893
...
def calc_deleted_chars_index(deleted_chars : String, dict : Hash(Int64, Int64)) : Int64
  n = 0_i64
  ...
  h.each do |k, v|
    next if k == ""
    i = v.size.to_i64
    dict[i] = i ** 2 unless dict.has_key?(i)
    n += dict[i]
  end
  n
end
...
queries.each do |query|
  if query.first == "1"
    ...
    puts calc_deleted_chars_index(deleted_chars, h)
  end
end
