...
# WA
# https://atcoder.jp/contests/abc168/submissions/13407143
...
class SardineGroup
  ...
  def calc(combination_calculator, mod) : Int64
    ...
    if basis_vector == [0_i64, 0_i64]
      raise "basis_vector is not valid."
    end
...
sardine_groups.each do |basis_vector, sardine_group|
  next if basis_vector == [0_i64, 0_i64]
...
unless sardine_group_with_zero_basis_vector.nil?
  i += sardine_group_with_zero_basis_vector.size % mod
end
